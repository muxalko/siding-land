        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
          <div className="animate-slide-in-right">
            <h2 className="text-4xl md:text-5xl font-bold mb-6">
              Why Choose Siding Land?
            </h2>
            <p className="text-lg mb-6 text-primary-foreground/90">
              With over 15 years of experience serving Greater Vancouver Area
              and Lower Mainland, we've built our reputation on quality
              workmanship, competitive pricing, and exceptional customer
              service.
            </p>
            <p className="text-lg mb-6 text-primary-foreground/90">
              Our team of licensed professionals uses only premium materials and
              follows industry best practices to ensure your siding installation
            ...
            <ul className="space-y-3">
              ...
              <li className="flex items-start gap-3">
                <div className="w-2 h-2 bg-accent rounded-full mt-2 flex-shrink-0" />
                <span>
                  Comprehensive warranties on all materials and workmanship
                </span>
              </li>
              <li className="flex items-start gap-3">
                <div className="w-2 h-2 bg-accent rounded-full mt-2 flex-shrink-0" />
